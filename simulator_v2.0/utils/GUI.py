...
class Gui:
    ...
    def menubar(self): # Creates the menu bar located at the top of the gui
    ...
    def create_legend(self): # creates the legend at the top left that displays the task type and its colored shape.
        k1, k2, y = 50, 100, 10
    ...
    def create_machine_names(self): # creates the list of machines available for scheduling and their queues on the right.
        # next few lines set up the image for the machiens
